// /api/review.js — lives in the FRONTEND project so it shares origin with admin.html
// Auth is via URL query parameter (?secret=xxx) — simplest possible, no headers, no CORS.
// Hardcoded password: rialo2026
...
const ADMIN_PASSWORD = 'rialo2026';
...
module.exports = async (req, res) => {
  try {
    // Auth via query param (no headers = no CORS preflight)
    ...
    if (req.method === 'GET') {
      ...
      let ids = filter === 'history' ? historyIds : pendingIds;
